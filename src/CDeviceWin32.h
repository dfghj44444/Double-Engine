...
#ifndef __C_DEVICE_WIN32_H_
#define __C_DEVICE_WIN32_H_
...
namespace doubal
{
	class CDeviceWin32 : public CDeviceStub//, video::IImagePresenter
	{
	public:

		//! constructor
		CDeviceWin32(const SCreationParameters& params);
		...
		virtual void sleep(unsigned int timeMs, bool pauseTimer);
		...
		//virtual bool present(video::IImage* surface, void* windowId=0, core::rect<int>* src=0);
		...
		//virtual bool activateJoysticks(std::vector<SJoystickInfo> & joystickInfo);
		...
		//	CCursorControl(const core::dimension2d<unsigned int>& wsize, HWND hwnd, bool fullscreen)
		...
		//	//! Sets the new position of the cursor.
		//	virtual void setPosition(const core::position2d<int> &pos)
		//	{
		//		setPosition(pos.X, pos.Y);
		//	}
		...
		//	virtual const core::position2d<int>& getPosition()
		//	{
		...
		//	virtual void setReferenceRect(core::rect<int>* rect=0)
		//	{
		//		if (rect)
		//		{
		//			ReferenceRect = *rect;
		...
		//	virtual void OnResize(const core::dimension2d<unsigned int>& size)
		//	{
		//		WindowSize = size;
		//		if (size.Width!=0)
		...
		//	core::position2d<int> CursorPos;
		//	core::dimension2d<unsigned int> WindowSize;
		//	core::dimension2d<float> InvWindowSize;
		//	HWND HWnd;

		//	int BorderX, BorderY;
		//	core::rect<int> ReferenceRect;
...
#if defined(_COMPILE_WITH_JOYSTICK_EVENTS_)
		struct JoystickInfo
		{
			unsigned int		Index;
			JOYCAPS Caps;
		};
		std::vector<JoystickInfo> ActiveJoysticks;
#endif
	};
