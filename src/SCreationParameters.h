...
/************************************************************************/
#ifndef _I_CREATION_PARAMETERS_H_
#define _I_CREATION_PARAMETERS_H_
...
namespace doubal
{
	...
	struct SCreationParameters
	{
		...
		SCreationParameters() :
			...
			WindowSize(core::dimension2d<unsigned int>(800, 600)),
			Bits(16),
			ZBufferBits(16),
			Fullscreen(false),
			Stencilbuffer(false),
			...
			SDK_version_do_not_use(DOUBLE_SDK_VERSION)
		{
		}

		SCreationParameters(const SCreationParameters& other) :
			SDK_version_do_not_use(DOUBLE_SDK_VERSION)
		{*this = other;}

		SCreationParameters& operator=(const SCreationParameters& other)
		{
