...
namespace core
{
	...
	*/
	...
	// Implementor note: inline keyword needed due to template specialization for int. Otherwise put specialization into a .cpp
	template <>
	...
	template <>
	inline vector3d<int> vector3d<int>::getSphericalCoordinateAngles()
	{
		vector3d<int> angle;
		const double length = X*X + Y*Y + Z*Z;
